"""autogenerated by genmsg_py from FreeFlyerState.msg. Do not edit."""
import roslib.message
import struct

import std_msgs.msg

class FreeFlyerState(roslib.message.Message):
  _md5sum = "5fbf541e654dab38ddd37689024b1edc"
  _type = "jrl_controller_manager/FreeFlyerState"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Message describing the transformation and velocity of a free-flying
# solid in space. 
# The position vector is of size 6: x,y,z,rx,ry,rz
# The velocity vector is of size 6: first linear speed, then instantaneous rotation vector
Header header
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FreeFlyerState, self).__init__(*args, **kwds)
